...
// Exact copy of working tip-artist function, modified for AI covers
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { prompt, model = 'flux-schnell', genre, style } = body;
    ...
    // Record payment in database (optional - won't fail if DB unavailable)
    try {
